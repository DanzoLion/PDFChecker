...
title = "Your Artwork of '%s', pages: %i" % (fname, page_count)
# ------------------------------------------------------------------------------
# read the page data
# ------------------------------------------------------------------------------
def get_page(pno, zoom=False, max_size=None):                                                             #None
...
# ------------------------------------------------------------------------------
root = tk.Tk()
max_width = root.winfo_screenwidth() - 20                 # 20
max_height = root.winfo_screenheight() - 135       # 135
...
layout = [  # the form layout
    [
        ...
        sg.Text("Please View Your Artwork and Make Sure Safe Zone and Bleed is Applied"),    # "(toggle on/off, use arrows to navigate while zooming)"
    ],
    [image_elem],
]
